...
xParams = NaN(3,4);
fun = @(theta) f(theta,copy(:,22),xTotal);
xParams(1,:) = bads(fun,theta0,LB,UB);
fun = @(theta) f(theta,copy(copy(:,8)<1000,22),xRight);
xParams(2,:) = bads(fun,theta0,LB,UB);
fun = @(theta) f(theta,copy(copy(:,8)>1000,22),xLeft);
...
yParams = NaN(3,4);
fun = @(theta) f(theta,copy(:,22),yTotal);
yParams(1,:) = bads(fun,theta0,LB,UB);
fun = @(theta) f(theta,copy(copy(:,8)<1000,22),yRight);
yParams(2,:) = bads(fun,theta0,LB,UB);
fun = @(theta) f(theta,copy(copy(:,8)>1000,22),yLeft);
yParams(3,:) = bads(fun,theta0,LB,UB);

xTotalLLH = log(1/sqrt(2*pi)) * length(copy(:,22)) + sum(-log(xParams(1,3).*copy(:,22) + xParams(1,4)) - (((xTotal - (xParams(1,1).*copy(:,22) + xParams(1,2))).^2)./ (2.*(xParams(1,3).*copy(:,22)+xParams(1,4)).^2)));
xRightLLH = log(1/sqrt(2*pi)) * length(copy(copy(:,8)<1000,22)) + sum(-log(xParams(2,3).*copy(copy(:,8)<1000,22) + xParams(2,4)) - (((xRight - (xParams(2,1).*copy(copy(:,8)<1000,22) + xParams(2,2))).^2)./ (2.*(xParams(2,3).*copy(copy(:,8)<1000,22)+xParams(2,4)).^2)));
xLeftLLH = log(1/sqrt(2*pi)) * length(copy(copy(:,8)>1000,22)) + sum(-log(xParams(3,3).*copy(copy(:,8)>1000,22) + xParams(3,4)) - (((xLeft - (xParams(3,1).*copy(copy(:,8)>1000,22) + xParams(3,2))).^2)./ (2.*(xParams(3,3).*copy(copy(:,8)>1000,22)+xParams(3,4)).^2)));
xLateralLLH = xRightLLH + xLeftLLH;

xaicTotal = 2 * 4 - 2 * xTotalLLH
xaicIndividual = 2 * 8 - 2 * xLateralLLH
xbicTotal = 4 * log(length(copy(:,22))) - 2 * xTotalLLH
xbicIndividual = 8 * log(length(copy(:,22))) - 2 * xLateralLLH

yTotalLLH = log(1/sqrt(2*pi)) * length(copy(:,22)) + sum(-log(yParams(1,3).*copy(:,22) + yParams(1,4)) - (((yTotal - (yParams(1,1).*copy(:,22) + yParams(1,2))).^2)./ (2.*(yParams(1,3).*copy(:,22)+yParams(1,4)).^2)));
yRightLLH = log(1/sqrt(2*pi)) * length(copy(copy(:,8)<1000,22)) + sum(-log(yParams(2,3).*copy(copy(:,8)<1000,22) + yParams(2,4)) - (((yRight - (yParams(2,1).*copy(copy(:,8)<1000,22) + yParams(2,2))).^2)./ (2.*(yParams(2,3).*copy(copy(:,8)<1000,22)+yParams(2,4)).^2)));
yLeftLLH = log(1/sqrt(2*pi)) * length(copy(copy(:,8)>1000,22)) + sum(-log(yParams(3,3).*copy(copy(:,8)>1000,22) + yParams(3,4)) - (((yLeft - (yParams(3,1).*copy(copy(:,8)>1000,22) + yParams(3,2))).^2)./ (2.*(yParams(3,3).*copy(copy(:,8)>1000,22)+yParams(3,4)).^2)));
yLateralLLH = yRightLLH + yLeftLLH;

yaicTotal = 2 * 4 - 2 * yTotalLLH
yaicIndividual = 2 * 8 - 2 * yLateralLLH
ybicTotal = 4 * log(length(copy(:,22))) - 2 * yTotalLLH
ybicIndividual = 8 * log(length(copy(:,22))) - 2 * yLateralLLH
%%
figure(1)
indices = 1:1600;
subplot(1,3,1)

plot(copy(:,22),xTotal,'o')
hold on
...
subplot(1,3,2)
plot(copy(copy(:,8)<1000,22),xRight,'o')
hold on
...
subplot(1,3,3)
plot(copy(copy(:,8)>1000,22),xLeft,'o')
hold on
...
subplot(1,3,2)
plot(copy(copy(:,8)<1000,22),yRight,'o')
hold on
...
subplot(1,3,3)
plot(copy(copy(:,8)>1000,22),yLeft,'o')
hold on
